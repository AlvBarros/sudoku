...
import 'package:sudoku/presentation/grid/exit_button.dart';
import 'package:sudoku/presentation/grid/ellapsed_time.dart';
import 'package:sudoku/presentation/grid/game_grid.dart';
import 'package:sudoku/presentation/grid/numpad.dart';
import 'package:sudoku/presentation/grid/reset_button.dart';
import 'package:sudoku/presentation/grid/undo_button.dart';
                  ...
                  ExitButton(
                    onExit: () {
                      ...
                      if (mounted) {
                        Navigator.of(
                          context,
                        ).pushReplacementNamed('/continuegame');
                      }
                    },
                  ),
                ],
                    ...
                    if (completed) {
                      ...
                      if (!correct) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text('There are mistakes in the puzzle.'),
                          ),
                        );
                        return;
                      }
